                    ...
                    children: [
                        ...
                        child: Container(
                              child: Column(
                                children: [
                                  ...
                                  const Text("Join Our Team", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
                                  const SizedBox(height: 20,),
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Text("Browse Available Jobs",style: TextStyle(color: Colors.white)),
                              Row(
