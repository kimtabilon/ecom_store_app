                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Flexible(
                                                                      child: RichText(
                                                                          text: TextSpan(text: "\$", style: const TextStyle(fontWeight: FontWeight.w500, color: Color.fromRGBO(0, 0, 0, 1.0)), children: <TextSpan>[
                                                                        TextSpan(
                                                                            text:
                                                                                "${productsModel!.price}",
                                                                            style:
                                                                                TextStyle(color: const Color(0xff324558), fontWeight: FontWeight.w600)),
                                                                      ])),
                                                                    ),
                                                                    Row(
                                                                      children: [
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    if(_sprice2 == '0' && _price2 == '0') ...[
                                                      if (productsModel!.related_products_sprice![_current2].toString() != 'null' && productsModel!.related_products_sprice![_current2].toString() != '0') ...[
                                                        Flexible(
                                                          fit: FlexFit.tight,
                                                          child: RichText(
                                                            text: TextSpan(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    if(_sprice3 == '0' && _price3 == '0') ...[
                                                      if (productsModel!.more_products_sprice![_current].toString() != 'null' && productsModel!.more_products_sprice![_current].toString() != '0') ...[
                                                        Flexible(
                                                          fit: FlexFit.tight,
                                                          child: RichText(
                                                            text: TextSpan(
